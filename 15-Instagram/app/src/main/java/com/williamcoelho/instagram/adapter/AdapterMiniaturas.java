...
public class AdapterMiniaturas extends RecyclerView.Adapter<AdapterMiniaturas.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemLista = LayoutInflater.from(context).inflate(R.layout.adapter_filtros, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            foto = itemView.findViewById(R.id.fotoFiltro);
            nomeFiltro = itemView.findViewById(R.id.nomeFiltro);
