package com.williamcoelho.instagram.adapter;
...
public class AdapterPesquisa extends RecyclerView.Adapter<AdapterPesquisa.MyViewHolder> {
    ...
    public AdapterPesquisa(List<Usuario> usuarios, Context c) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemLista = LayoutInflater.from(context).inflate(R.layout.adapter_pesquisa, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(usuario.getLinkFoto() != null){
            ...
            Uri uri = Uri.parse(usuario.getLinkFoto());
